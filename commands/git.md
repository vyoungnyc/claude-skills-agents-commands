...
1. Encourage **small, focused commits** aligning with plan steps.
2. Always show commands; the user chooses what to run.
3. Keep explanations clear for users who are not git experts.
