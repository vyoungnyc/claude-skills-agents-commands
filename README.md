...
| /codereview | Interactive up-to-7-angle code review — 6 Claude sub-agents (including an adversarial reviewer) + 1 Codex reviewer, haiku scoring, cross-source dedup. Pass `--no-codex` to skip the Codex reviewer. Surfaces all findings; you decide what to fix. |
